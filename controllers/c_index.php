...
$sccentries=entries($posts_data_query."WHERE textupdates.replaced_at IS NULL AND posts.deleted_at IS NULL AND ( posts.category & 56 ) != 0 AND ( posts.category & 2 ) = 0 AND ( posts.category & 448 ) != 0 ");
