    ...
    <div class="flex flex-column items-center justify-center w-full h-full">
        <div class="flex gap-5" style="transform: translateY(5%);">
            <picture class="h-24 w-24 lg:h-52 lg:w-52">
                <source srcset="https://leneth.neocities.org/cecsdata/img/logoblanco.webp" type="image/webp">
                <source srcset="https://leneth.neocities.org/cecsdata/img/logoblanco.png" type="image/png"> 
                <img src="https://leneth.neocities.org/cecsdata/img/logoblanco.png" alt="Logo">
            </picture>
            <picture class="h-32 w-32 lg:h-64 lg:w-64" style="transform:translatey(-17%)">
                <source srcset="https://leneth.neocities.org/cecsdata/img/suizablanco.webp" type="image/webp">
                <source srcset="https://leneth.neocities.org/cecsdata/img/suizablanco.png" type="image/png"> 
                <img src="https://leneth.neocities.org/cecsdata/img/suizablanco.png" alt="Logo">
            </picture>
        </div>
